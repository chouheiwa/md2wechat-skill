...
| 特性 | 描述 |
|------|------|
| **AI 转换** | 使用 Claude AI 生成精美排版 HTML |
| **图片处理** | 本地上传、在线下载两种方式 |
| **样式系统** | 内置多套主题，支持自定义 |
| **微信集成** | 直接上传素材、创建草稿 |
...
选项:
  --theme <name>           主题/提示词名称，默认 autumn-warm
...
# 上传图片
md2wechat convert article.md --theme autumn-warm --upload

# 自定义 AI 提示词
md2wechat convert article.md --custom-prompt "使用暗黑科技风格..."

# 创建草稿
md2wechat convert article.md --theme autumn-warm --upload --draft
...
| `DEFAULT_THEME` | 默认主题 | 否 | `autumn-warm` |
